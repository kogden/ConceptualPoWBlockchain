...
import com.transactions.TransactionInput;
import com.transactions.TransactionOutput;
...
public class Wallet {
    ...
    // generate private/public keys using Elliptic-curve cryptography
    ...
    public float getBalance() {
        float total = 0;
        for(Map.Entry<String, TransactionOutput> item : KogsChain.UTXOs.entrySet()) {
    ...
    public Transaction sendFunds(PublicKey _recipient, float value) {
        if(getBalance() < value) { //check funds
            System.out.println("#Not enough funds to send transaction. Transaction canceled");
            return null;
        }
